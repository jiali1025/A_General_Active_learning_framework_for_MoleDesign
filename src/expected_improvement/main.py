...
from batch_diversity import cut_and_pred_target_v1
...
def main():
    for i in range(start_round, total_round):
        ...
        decay_param = 25
        cut_and_pred_target_v1(dt_tot, 30000, i, check_point_path)
        print(f'cut_and_pred_target_v1 for round{i} has been finished')
        time.sleep(10)
