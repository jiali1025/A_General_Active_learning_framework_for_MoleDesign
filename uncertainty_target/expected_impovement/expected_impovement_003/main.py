...
from cut_and_pred_expected_improvement import cut_and_pred_expected_improvement
...
def main():
    for i in range(start_round, total_round):
        ...
        decay_param = 25
        cut_and_pred_expected_improvement(dt_tot, 30000, i, check_point_path, 0.03)
        print(f'cut_and_pred_expected_improvement for round{i} has been finished')
        time.sleep(10)
