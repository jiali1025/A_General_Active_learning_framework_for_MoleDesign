...
from cut_and_pred_uncertainty_target_property_average_batch_diversity import cut_and_pred_uncertainty_target_property_average_batch_diversity
import subprocess
...
def main():
    for i in range(start_round, total_round):
        if i > 5:
            ...
            cut_and_pred_uncertainty_target_property_average_batch_diversity(dt_tot, 30000, i, check_point_path)
