...
from cut_and_pred_target_batch_diversity import cut_and_pred_target_batch_diversity
...
def main():
    for i in range(start_round, total_round):
        ...
        cut_and_pred_target_batch_diversity(dt_tot, 30000, i, check_point_path)
        print(f'cut_and_pred_target_batch_diversity for round{i} has been finished')
        time.sleep(10)
