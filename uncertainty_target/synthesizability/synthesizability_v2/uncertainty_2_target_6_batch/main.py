...
from cut_and_pred_batch_diversity import cut_and_pred_batch_diversity
import subprocess
...
def main():
    for i in range(start_round, total_round):
        ...
        if i <= 2:
            cut_and_pred_batch_diversity(dt_tot, 30000, i, check_point_path, threshold_value, threshold_num)
