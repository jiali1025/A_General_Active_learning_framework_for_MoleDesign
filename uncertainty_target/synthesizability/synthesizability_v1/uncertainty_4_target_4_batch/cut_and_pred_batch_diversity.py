def cut_and_pred_batch_diversity(dt_tot_csv, cut_len, round, check_point_path, similar_value_threshold, similar_num_threshold):
    import math
    import os
    import pandas as pd
    import time
    ...
    pred_tot['uncertainty_mix'] = (pred_tot['uncertainty_tot'] - pred_tot['uncertainty_tot'].median()) / IQR + pred_tot['Synthesizability']
    pred_tot.sort_values(by = 'uncertainty_mix', ascending = False, inplace = True)
