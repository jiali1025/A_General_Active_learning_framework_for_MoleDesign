...
from cut_and_pred_uncertainty_nobatch_target_property_batch_diversity import cut_and_pred_uncertainty_nobatch_target_property_batch_diversity
import subprocess
...
def main():
    for i in range(start_round, total_round):
        ...
        decay_param = 25
        cut_and_pred_uncertainty_nobatch_target_property_batch_diversity(dt_tot, 30000, i, check_point_path, decay_param)
        print(f'cut_and_pred for round{i} has been finished')
        time.sleep(10)
