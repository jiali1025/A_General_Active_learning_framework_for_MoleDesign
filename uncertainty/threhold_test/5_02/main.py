...
from cut_and_pred_threshold_test import cut_and_pred_threshold_test
...
def main():
    for i in range(start_round, total_round):
        ...
        cut_and_pred_threshold_test(dt_tot, 30000, i, check_point_path, threshold_value, threshold_num)
