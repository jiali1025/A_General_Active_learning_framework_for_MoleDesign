...
from cut_and_pred_target_property_v1_separation_batch_diversity import cut_and_pred_target_property_v1_separation_batch_diversity
...
def main():
    for i in range(start_round, total_round):
        ...
        decay_param = 1
        cut_and_pred_target_property_v1_separation_batch_diversity(dt_tot, 30000, i, check_point_path, decay_param)
