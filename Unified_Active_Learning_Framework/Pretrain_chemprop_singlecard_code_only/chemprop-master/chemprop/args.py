...
#     mask_atom_columns: List[str] = None
#     """
...
#         'mse', 'bounded_mse', 'binary_cross_entropy', 'cross_entropy', 'mcc', 'sid', 'wasserstein', 'mve', 'evidential', 'dirichlet'] = 'cross_entropy'
#     """Choice of loss function. Loss functions are limited to compatible dataset types."""
#     multiclass_num_classes: int = 26
...
class TrainArgs(CommonArgs):
    ...
    """Choice of loss function. Loss functions are limited to compatible dataset types."""
    multiclass_num_classes: int = 2531
    """Number of classes when running multiclass classification."""
    separate_val_path: str = None
    """Path to separate val set, optional."""
    separate_test_path: str = None
